...
const TechnicalGrowthChart = () => {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold mb-4 text-black">Technical User Growth (Last 30 Days)</h2>
...
export default TechnicalGrowthChart;