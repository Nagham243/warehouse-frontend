...
const TechnicalFormModal = ({ isOpen, onClose, onSubmit, technicalUser }) => {
  const { t } = useTranslation();
  const isEditing = !!technicalUser;
  ...
  useEffect(() => {
    if (technicalUser) {
      setFormData({
        ...
        first_name: technicalUser.first_name || "",
        last_name: technicalUser.last_name || "",
        password: "",
        password_confirm: "", 
        user_type: "technical", 
        is_active: technicalUser.is_active !== undefined ? technicalUser.is_active : true
      });
    } else {
      setFormData(defaultFormData);
    }
    setErrors({});
  }, [technicalUser, isOpen]);
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-800">
            {isEditing ? t('technicals.editTechnicalUser') : t('technicals.addNewTechnical')}
          </h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            >
              {isEditing ? t('technicals.updateTechnicalUser') : t('technicals.addNewTechnical')}
            </button>
          </div>
        </form>
      </motion.div>
...
export default TechnicalFormModal;