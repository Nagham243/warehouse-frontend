...
const AIPoweredInsights = () => {
	return (
		<motion.div
			className='bg-gray-300 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-gray-300'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 1.0 }}
		>
			<h2 className='text-xl font-semibold text-black mb-4'>AI-Powered Insights</h2>
