...
const UserGrowthChart = () => {
  ...
  useEffect(() => {
    const fetchGrowthData = async () => {
      try {
        setLoading(true);
        const response = await axios.get('/api/users/growth_stats/', {
          headers: {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold mb-4 text-black">{t('users.growthChartTitle')}</h2>
